             ...
             {activeOrder ? (
              ...
              <div className="mx-5 mt-6">
                ...
                <div className="flex justify-center gap-2 mt-3">
                  <div className={`w-2 h-2 rounded-full transition-colors ${activeBannerIndex === 0 ? 'bg-[#5260FE]' : 'bg-[#5260FE]/10 dark:bg-muted'}`} />
                  <div className={`w-2 h-2 rounded-full transition-colors ${activeBannerIndex === 1 ? 'bg-[#5260FE]' : 'bg-[#5260FE]/10 dark:bg-muted'}`} />
                </div>
              </div>
            )}
