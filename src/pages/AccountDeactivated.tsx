  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Body */}
        <p
          className={`${isDarkMode ? 'text-[#AFAFAF]' : 'text-black'} text-[13px] font-normal font-sans leading-relaxed mt-[17px]`}
        >
      ...
      <div className="w-[362px] mt-auto relative z-10">
        <Button
          ...
          className={`w-full h-[52px] rounded-full font-semibold text-[16px] border-none ${
            isDarkMode
      ...
      {/* Redirect Text */}
      <p
        className={`${isDarkMode ? 'text-[#AFAFAF]' : 'text-black/60'} text-[14px] font-normal font-sans mt-[15px] relative z-10`}
      >
