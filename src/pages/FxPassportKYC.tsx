...
const FxPassportKYC = () => {
  ...
  return (
    ...
    >
      {/* Header */}
      <div className="px-5 safe-top pt-1 flex items-center justify-between z-10 mb-[21px] relative">
        <BackButton onClick={() => navigate(-1)} />
        <h1 className="text-white text-[22px] font-medium font-sans">Passport Verification</h1>
        <div className="w-10" />
      </div>
      <div className="px-5 safe-bottom pb-4 flex-1 flex flex-col justify-between">
          ...
          <div className="animate-in slide-in-from-bottom-4 duration-500">
            <div className="mt-8">
              ...
              <p className="text-white/50 text-[14px] mt-2">
                Please upload clear photos of your passport pages.
              </p>
            </div>
            <div className="mt-10 space-y-6">
              ...
              {/* Back Page */}
              <div className="space-y-3">
                <p className="text-white/70 text-[14px] font-medium ml-1">
                  Back Page (Address Page)
                </p>
                <button
        ...
        {step === 'success' && (
          <div className="mt-10 flex flex-col items-center animate-in zoom-in-95 duration-500">
            ...
            <h3 className="mt-10 text-white text-[24px] font-bold text-center">
              Passport Verified!
            </h3>
            <p className="mt-4 text-white/60 text-[16px] text-center max-w-[300px] leading-relaxed">
              Your identity has been successfully confirmed. You now have full access to
              International FX Exchange.
            </p>
