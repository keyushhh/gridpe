...
const LinkedAccounts = () => {
  ...
  const handleAddAccounts = () => {
    ...
    navigate(ROUTES.BANKING, { state: { accountsAdded: true, selectedAccounts: accountsToAdd } });
  };
  const isAllSelected =
    selectedAccountIds.length === AVAILABLE_BANKS.length && AVAILABLE_BANKS.length > 0;
  return (
    <div
      ...
      <div className="flex-1 px-5 mt-8 overflow-y-auto overscroll-y-none scrollbar-hide pb-40">
        ...
        <div
          ...
          style={
            isDarkMode
              ? {
                  backgroundImage: `url(${ASSETS.BANK_ACC_CONTAINERS})`,
                  backgroundSize: 'cover',
                ...
                <div key={account.id}>
                  ...
                  >
                    ...
                    <div className="flex-1">
                      ...
                      <p
                        className={`${isDarkMode ? 'text-white/40' : 'text-black/40'} text-[13px] mt-0.5`}
                      >
