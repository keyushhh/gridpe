...
const DowngradePlan = () => {
    ...
    return (
        ...
        >
            ...
            {
                selectedTier && (
                    <div className={`fixed bottom-0 left-0 right-0 flex flex-col items-center pt-[20px] safe-bottom pb-4 z-[100] ${isDarkMode ? 'bg-black' : 'bg-white border-t border-[#E9EAEB]'}`}>
                        {/* Note Container */}
                        <div
