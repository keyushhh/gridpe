  ...
  return (
    ...
    >
      ...
      <div className="flex-1 px-5 pt-4 relative z-10">
        <p
          className={`${isDarkMode ? 'text-white' : 'text-black'} text-[16px] font-sans leading-relaxed mb-6`}
        >
          ...
          {benefits.map((benefit, index) => (
            <div key={index}>
              <div className="flex items-center gap-2">
                <span
                  className={`${isDarkMode ? 'text-white' : 'text-black'} text-xl leading-none`}
                >
                  •
                </span>
                <h3
              ...
              <p
                className={`${isDarkMode ? 'text-brand-text-muted' : 'text-black/50'} text-[13px] font-normal font-sans ml-4 mt-1`}
              >
                {benefit.description}
              </p>
            </div>
      ...
      <div className="mt-auto safe-bottom pb-4 space-y-4 relative z-10 flex flex-col items-center">
        <button
          onClick={() => navigate(ROUTES.KYC_FORM)}
        ...
        <div className="fixed inset-0 z-50 flex flex-col items-center justify-center p-6">
          ...
          >
            <div className="flex flex-col items-center">
              ...
              />
              <h2
                className={`${isDarkMode ? 'text-white' : 'text-black'} text-[18px] font-semibold font-sans mb-4`}
              >
                Know Your Customer
              </h2>
