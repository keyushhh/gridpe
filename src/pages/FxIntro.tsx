        ...
        >
            ...
            <div className="flex-1 overflow-y-auto no-scrollbar scroll-smooth">
                <div className="w-full px-5 flex flex-col" style={{ paddingTop: '46px' }}>
                    ...
                    {/* Main Heading */}
                    <h2 className={`${isDarkMode ? "text-white" : "text-black"} text-[16px] font-bold font-satoshi leading-tight`}>
                    ...
                    <div className="mt-6">
                        ...
                        <ul className="mt-3 space-y-3 pl-1">
                            <li className={`${isDarkMode ? "text-white/80" : "text-black/80"} text-[14px] font-regular font-satoshi leading-[150%]`}>
                    ...
                    {/* Why Upgrade Section */}
                    <div className="mt-10">
                        <h3 className={`${isDarkMode ? "text-white" : "text-black"} text-[18px] font-bold font-satoshi mb-5`}>
                            Why Upgrade for FX Exchange?
                        </h3>
                        <div className="space-y-6 pl-1">
                            <div className={`${isDarkMode ? "text-white/80" : "text-black/80"} text-[14px] font-regular font-satoshi leading-[160%]`}>
