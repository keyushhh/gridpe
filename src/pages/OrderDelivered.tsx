  ...
  return (
    ...
    >
      ...
      <div className="h-full w-full overflow-hidden flex flex-col safe-top relative z-10 w-full pt-4">
        ...
        <h1
          className={`text-[22px] font-medium font-satoshi text-center ${isDarkMode ? 'text-white' : 'text-black'}`}
        >
          Order Delivered
        </h1>
        ...
        <p
          className={`mt-[35px] text-[18px] font-bold font-satoshi text-center ${isDarkMode ? 'text-white' : 'text-black'}`}
        >
        ...
        >
          ...
          <h2
            className={`text-[16px] font-medium font-satoshi leading-tight ${isDarkMode ? 'text-white' : 'text-black'}`}
          >
