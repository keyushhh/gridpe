  ...
  return (
    ...
    >
      ...
      <div className="mt-[21px] mb-[35px] relative z-10">
        <img
          src={isDarkMode ? sadFace : sadFaceRed}
          alt="Sad Face"
      ...
      >
        <p className={`${isDarkMode ? 'text-white' : 'text-black'} text-[16px] font-medium font-sans mb-[12px]`} style={{ lineHeight: '140%' }}>
          No worries — it's not like we cried or anything.
        </p>

        <div className={`${isDarkMode ? 'text-[#AFAFAF]' : 'text-black'} text-[16px] font-normal font-sans mb-[12px]`} style={{ lineHeight: '120%' }}>
          <p className="mb-1">
      ...
      <div className="w-full mt-auto flex flex-col items-center relative z-10">
        ...
        <p className={`${isDarkMode ? 'text-white/40' : 'text-black/40'} text-[13px] font-sans mt-[8px]`}>
