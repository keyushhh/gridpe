...
const WalletTopUpSuccess = () => {
    ...
    return (
        <div className="min-h-screen flex flex-col items-center p-6 relative overflow-hidden font-sans safe-top bg-white dark:bg-[#0F1115] dark:bg-[url('@/assets/success-bg.png')] dark:bg-cover dark:bg-center dark:bg-no-repeat">
            ...
            <div className="flex flex-col items-center w-full mt-10 z-10">
                ...
                >
                    ...
                    <p className="mt-[12px] text-[#4A4A4A] dark:text-[#AFAFAF] text-[16px] font-normal" style={{ lineHeight: '120%' }}>
                        You didn’t add it to spend digitally. You added it... to make that cash come to YOU. No ATMs, no queues, no awkward eye contact.
                        <br />
                        Just pure financial laziness, powered by tech.
                    </p>

                    <div className="mt-[20px] flex items-center gap-[12px]">
                        <img src={elipseGreenIcon} alt="" className="w-[12px] h-[12px] object-contain" />
            ...
            {/* Footer Text */}
            <p className="text-[#666666] dark:text-white/60 text-[12px] font-medium font-sans mt-[12px] text-center z-10">
